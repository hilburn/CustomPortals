package customportals.reference;

public class Reference
{
    // User friendly version of our mods name.
    public static final String NAME = "Custom Portals";

    // Internal mod name used for reference purposes and resource gathering.
    public static final String ID = "CustomPortals";
    public static final String ID_LOWERCASE = "customportals";
